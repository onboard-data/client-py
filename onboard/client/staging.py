...
class StagingClient(ClientBase):
    ...
    def update_building_details(
        self, building_id: int, details: Dict[str, Any]
    ) -> Dict:
    ...
    @deprecation.deprecated(
        deprecated_in="1.14.0", details="Replaced with get_staging_equipment"
    )
    ...
    @deprecation.deprecated(
        ...
        details="get_staging_points and "
    ...
    @json
    @deprecation.deprecated(
        deprecated_in="1.14.0", details="replaced with get_staging_points"
    )
    ...
    @json
    @deprecation.deprecated(
        deprecated_in="1.14.0", details="replaced with get_staging_devices"
    )
    ...
    def get_staged_equipment_csv(self, building_id: int) -> str:
        ...
        @json
        def get_csv():
            return self.get(f"/staging/{building_id}", headers={"Accept": "text/csv"})
    ...
    @json
    @deprecation.deprecated(
        deprecated_in="1.14.0", details="Use update_staging_equipment instead"
    )
    ...
    def promote_from_staging(
        self, building_id: int, equip_ids: List[str] = [], topics: List[str] = []
    ) -> Dict:
    ...
    @json
    def unpromote_from_staging(
        self,
        building_id: int,
        equipment_ids: List[int] = [],
        point_ids: List[int] = [],
        equipment_point_pairs: List[Tuple[int, int]] = [],
    ) -> Dict:
        ...
        promote_req = {
            ...
            "point_equipment_relationships": [
                ...
                for equipment_id, point_id in equipment_point_pairs
            ],
        }
